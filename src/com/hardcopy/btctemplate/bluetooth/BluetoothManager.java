        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    String mynewstring1 = new String(buffer_b);

                    String[] r_message = mynewstring1.split("\\*");
                    String mes;


                    for (int i = 0; i < r_message.length; i++) {
                        mes = r_message[i].toString();
...
//                		if(MainActivity.sampleCount < MainActivity.FFTsampleNum){			// FFT µ•¿Ã≈Õ ¿˙¿Â
//                			double value = Double.parseDouble(mes);							// parseDouble¿Ã π√¡¶ø©º≠ πŸ≤„æﬂµ 
//                			
//                			if(MainActivity.sampleCount % 2 == 0)								
//                				MainActivity.fftData[MainActivity.sampleCount] = value;
//                			else
//                				MainActivity.fftData[MainActivity.sampleCount] = 0;
//                			MainActivity.sampleCount++;
//                		}


                        //Log.e("Split",new String(send, "UTF-8"));
                    }
