...
import com.hardcopy.btctemplate.bluetooth.BluetoothManager;
import com.hardcopy.btctemplate.bluetooth.ConnectionInfo;
import com.hardcopy.btctemplate.bluetooth.TransactionBuilder;
import com.hardcopy.btctemplate.bluetooth.TransactionReceiver;
...
public class BTCTemplateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        return Service.START_NOT_STICKY;    // NOT STICKY 로 변경함
    }
            ...
            switch (msg.what) {
                ...
                case BluetoothManager.MESSAGE_READ:
                    ...
                    if (mTransactionReceiver != null) {
                        ...
                        // 메인 핸들러에 MESSAGE_BT_READ 태그를 달아 data를 전송
